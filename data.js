// ========================================
// 北京轨道交通TOD数据 — 机遇区信息
// citylines.co 真实GeoJSON数据由外部JSON文件加载
// ========================================

// 在建线路补充数据（citylines.co 中尚未完整收录的线路）
const SUPPLEMENTARY_UC_LINES = [
  {
    id: 'line13_expand', name: '13号线扩能提升',
    color: '#f4da40', status: '在建',
  ...
  {
    id: 'line13_expand_east', name: '13号线扩能提升（东段）',
    color: '#f4da40', status: '在建',
    description: '13号线扩能东段',
    coords: [
      [116.3600,40.0600],[116.3809,40.0600],[116.4000,40.0600],[116.4166,40.0500],
      [116.4250,40.0430],[116.4350,40.0318],[116.4203,40.0750]
    ]
  },
  {
    id: 'line22', name: '22号线（平谷线）',
    color: '#CB6A43', status: '在建',
  ...
  {
    id: 'line28', name: '28号线',
    color: '#3E6DB5', status: '在建',
    description: '串联东直门商务区、CBD、百子湾居住组团',
    coords: [
